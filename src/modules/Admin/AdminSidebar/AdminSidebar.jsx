  ...
  return (
    <>
     <div className="bg-white sidebar p-2">
        <div className="m-2">
            <a href="/">
              <svg style={{ width: "102", height: "32", color: "#FF385C" }} className="me-2 fs-4">
                <path
                  fill="currentcolor"
        ...
        <div className="list-group list-group-flush">
          <a className="list-group-item list-group-item-action py-2" onClick={handleThongTin}>
            <i className="bi bi-person-circle fs-5 me-3"></i>
            <span>Thông tin cá nhân</span>
          </a>
          <div>
            <a
              className={`list-group-item list-group-item-action py-2 ${activeFooterItem === 2 ? "action" : ""}`}
          ...
          <div>
            <a
              className={`list-group-item list-group-item-action py-2 ${activeFooterItem === 3 ? "action" : ""}`}
          ...
          <div>
            <a
              className={`list-group-item list-group-item-action py-2 ${activeFooterItem === 4 ? "action" : ""}`}
          ...
          <div>
            <a className="list-group-item list-group-item-action py-2" onClick={handleHistory}>
              <i className="bi bi-book fs-5 me-3"></i>
              <span>Quản lý đặt phòng</span>
            </a>
          </div>
          <div>
            <a className="list-group-item list-group-item-action py-2" onClick={handleComment}>
              <i className="bi bi-chat-dots fs-5 me-3"></i>
              <span>Quản lý bình luận</span>
            </a>
          </div>
          <div>
            <a className="list-group-item list-group-item-action py-2" onClick={handleSignOut}>
