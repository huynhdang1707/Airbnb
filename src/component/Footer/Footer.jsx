          ...
          <div className="col-sm-3">
            <section>
              ...
              <ul>
                ...
                <li className='mt-3'><a href="#" className='noiDung'>Báo cáo lo ngại của hàng xóm</a></li>
              </ul>
            </section>
          </div>
          <div className="col-sm-3">
            <section>
              <h3 className='tieuDe'>Cộng đồng</h3>
              <ul>
                <li className='mt-3'><a href="#" className='noiDung'>Airbnb.org: nhà ở cứu trợ</a></li>
                <li className='mt-3'><a href="#" className='noiDung'>Chống phân biệt đối xử</a></li>
              </ul>
            </section>
          </div>
          <div className="col-sm-3">
            <section>
              <h3 className='tieuDe'>Đón tiếp khách</h3>
              <ul>
                ...
                <li className='mt-3'><a href="#" className='noiDung'>Đón tiếp khách có trách nhiệm</a></li>
              </ul>
            </section>
          </div>
          <div className="col-sm-3">
            <section>
              <h3 className='tieuDe'>Airbnb</h3>
              <ul>
